...
std::map<WindowsFingerprint::WindowsEditionSKU, WindowsFingerprint::EditionInfo> WindowsFingerprint::editions_by_product(WindowsFingerprint::ProductName product_name) const
{
